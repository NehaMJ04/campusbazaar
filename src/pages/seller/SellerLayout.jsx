...
const NAV_ITEMS = [
  ...
  { path: "/seller/shops",       label: "My Shops",           icon: "🏪" },
...
export default function SellerLayout() {
  ...
  async function fetchProfile() {
    try {
      ...
      if (collegeError) console.error("Profile detail fetch error:", collegeError);
  ...
  const s = {
    ...
    quickBtn: {
      ...
      background:"#fff", border:"1px solid #ede4e0",
      borderRadius:8, cursor:"pointer", fontFamily:"inherit",
      fontSize:13.5, color:"#4e1c1c", fontWeight:500,
      marginBottom:8, transition:"background 0.15s, border-color 0.15s",
      textAlign:"left",
    },

    panelDivider: { border:"none", borderTop:"1px solid #ede4e0", margin:"4px 0 12px" },
    ...
    <div style={s.layout}>
      ...
      <aside style={s.sidebar}>
        ...
        <nav style={s.nav}>
          ...
          <button
            style={s.navBtn(false)}
            onClick={() => navigate("/")}
            title={collapsed ? "Browse Marketplace" : undefined}
            onMouseEnter={e => { e.currentTarget.style.background="rgba(255,255,255,0.07)"; e.currentTarget.style.color="rgba(255,255,255,0.90)"; }}
            onMouseLeave={e => { e.currentTarget.style.background="transparent"; e.currentTarget.style.color="rgba(255,255,255,0.62)"; }}
          >
            <span style={s.dot(false)} />
            <span style={s.navLabel}>Browse Marketplace ↗</span>
          </button>
          ...
          <button
            ...
            title={collapsed ? "My Purchases" : undefined}
            onMouseEnter={e => { e.currentTarget.style.background="rgba(255,255,255,0.07)"; e.currentTarget.style.color="rgba(255,255,255,0.90)"; }}
            onMouseLeave={e => { e.currentTarget.style.background="transparent"; e.currentTarget.style.color="rgba(255,255,255,0.62)"; }}
          >
            <span style={s.dot(false)} />
            <span style={s.navLabel}>My Purchases ↗</span>
          </button>
      ...
      <div style={s.slideout}>
        ...
        <div style={s.panelBody}>
          ...
          <div style={s.pName}>{profile?.name || "Seller"}</div>
          <div style={s.pEmail}>{profile?.email || ""}</div>
          <div style={s.pBadgeWrap}>
            <span style={s.pBadge}>Seller</span>
          </div>
          ...
          {[
            ...
            <div style={s.infoRow} key={key}>
              <span style={s.infoKey}>{key}</span>
              <span style={s.infoVal}>{val}</span>
            </div>
          ) : null)}

          {/* ── Buyer actions section ── */}
          <div style={s.sectionLabel}>As a Buyer</div>

          <button
            style={s.quickBtn}
            onClick={() => { setProfileOpen(false); navigate("/buyer/"); }}
            onMouseEnter={e => { e.currentTarget.style.background="#f5eeee"; e.currentTarget.style.borderColor="#d4b8b8"; }}
            onMouseLeave={e => { e.currentTarget.style.background="#fff"; e.currentTarget.style.borderColor="#ede4e0"; }}
          >
             My Purchases
          </button>
          ...
          <button
            style={s.quickBtn}
            onClick={() => { setProfileOpen(false); navigate("/buyer/cart"); }}
            onMouseEnter={e => { e.currentTarget.style.background="#f5eeee"; e.currentTarget.style.borderColor="#d4b8b8"; }}
            onMouseLeave={e => { e.currentTarget.style.background="#fff"; e.currentTarget.style.borderColor="#ede4e0"; }}
          >
             My Cart
          ...
          <button    //check and delete later
            style={s.quickBtn}
            onClick={() => { setProfileOpen(false); navigate("/buyer/products"); }}
            onMouseEnter={e => { e.currentTarget.style.background="#f5eeee"; e.currentTarget.style.borderColor="#d4b8b8"; }}
            onMouseLeave={e => { e.currentTarget.style.background="#fff"; e.currentTarget.style.borderColor="#ede4e0"; }}
          >
             Browse Marketplace
